...
export declare type TransactionOnChangeHook<T> = (previousData: T | undefined, newData: T | undefined, transaction: Transaction) => (void | TransactionSuccessHook<T>) | PromiseLike<void | TransactionSuccessHook<T>>;
export declare type TransactionSuccessHook<T> = (result: T | undefined) => (void | PromiseLike<void>);
...
export interface Strapi {
    ...
    contentTypes: {
        [key: string]: StrapiModel;
    };
    admin: Readonly<StrapiPlugin>;
    plugins: {
        [key: string]: Readonly<StrapiPlugin>;
    };
...
export declare type StrapiModelRecord = {
...
export declare type AttributeKey<T extends object> = Extract<keyof T, string>;
...
export declare type StrapiRelationType = 'oneWay' | 'manyWay' | 'oneToMany' | 'oneToOne' | 'manyToMany' | 'manyToOne' | 'oneToManyMorph' | 'manyToManyMorph' | 'manyMorphToMany' | 'manyMorphToOne' | 'oneMorphToOne' | 'oneMorphToMany';
export declare type StrapiAttributeType = 'integer' | 'float' | 'decimal' | 'biginteger' | 'string' | 'text' | 'richtext' | 'email' | 'enumeration' | 'uid' | 'date' | 'time' | 'datetime' | 'timestamp' | 'json' | 'boolean' | 'password' | 'dynamiczone' | 'component';
...
export declare type StrapiWhereOperator = 'eq' | 'ne' | 'in' | 'nin' | 'contains' | 'ncontains' | 'containss' | 'ncontainss' | 'lt' | 'lte' | 'gt' | 'gte' | 'null';
