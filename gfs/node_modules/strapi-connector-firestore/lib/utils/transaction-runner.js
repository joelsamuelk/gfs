...
exports.makeTransactionRunner = void 0;
const readwrite_transaction_1 = require("../db/readwrite-transaction");
const p_queue_1 = require("p-queue");
const readonly_transaction_1 = require("../db/readonly-transaction");
/**
...
function makeTransactionRunner(firestore, options, connectorOptions) {
    ...
    const normalRunner = async (fn, opts) => {
        ...
        if (isReadOnly) {
            ...
            const trans = new readonly_transaction_1.ReadOnlyTransaction(firestore, logTransactionStats && !isVirtual);
            ...
            return await firestore.runTransaction(async (trans) => {
                ...
                const wrapper = new readwrite_transaction_1.ReadWriteTransaction(firestore, trans, logTransactionStats, ++attempt);
                const result = await fn(wrapper);
                await wrapper.commit();
                return result;
            }, { maxAttempts: opts === null || opts === void 0 ? void 0 : opts.maxAttempts });
        }
    };
...
exports.makeTransactionRunner = makeTransactionRunner;
