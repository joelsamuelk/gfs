 ...
 */
export declare function isEqualHandlingRef(a: any, b: any): boolean;
/**
 * The shape of references as stored in Firestore.
 */
export declare type ReferenceShape<T extends object> = DocumentReference<T> | FlatReferenceShape<T> | MorphReferenceShape<T>;
...
export declare type MorphReferenceShape<T extends object> = NormalMorphReferenceShape<T> | FlatMorphReferenceShape<T>;
 ...
 */
export declare abstract class Reference<T extends object> {
